// Added FXAA, fixed blurry screen, improved motion blur quality, improved Definition setting behavior (doesn't affect stipple smoothing and DOF, only motion blur), console-like gamma
...
//
	...
	mov r5.w, c1.x
	if_eq r0.y, c1.x	// if Definition = ON, don't render motion blur
		rep i0
