...
//
	...
	if_eq r0.y, c100.y		// if (r0.y = 0) DOF = on, else off
		mov r20, c10
		...
		mov r3, r21 // final result (DOF on)
	else
		mov r3, r1 // final result (DOF off)
	endif
	mov r4, r3
	mov r5, r3
	mov r2, r3
    ...
    dp3 r0.z, r6, c1.yzww
    dp3 r7.x, r11, c1.yzww // near pixelation, needs clean HDRSampler
    dp3 r7.y, c1.x, c1.yzww // near pixelation, needs to be 0
    dp3 r7.z, r5, c1.yzww
    dp3 r7.w, r2, c1.yzww
    dp4 r0.w, r7, c2.x
    add r7, r7, -r0.w
	...
	// Console-like gamma, uncomment the three lines below to use
	mul r12, r0, r2.x
