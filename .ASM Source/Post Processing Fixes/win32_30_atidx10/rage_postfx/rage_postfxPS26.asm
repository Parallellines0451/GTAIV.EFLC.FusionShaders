// Added FXAA, fixed blurry screen, improved motion blur quality, improved Definition setting behavior (doesn't affect stipple smoothing and DOF, only motion blur), console-like gamma, fixed DOF resolution scaling, console-like TLAD noise tiling
...
//
	...
	mov r6.w, c1.x
	if_eq r0.w, c1.x	// if Definition = ON, don't render motion blur
		rep i0
    ...
    frc r1.xy, r1
	mul r1, r1, c2.x	// Console noise tiling
    texld r1, r1, s3
    add r0.w, r1.z, c4.x
    mul r0.w, r0.w, c85.z
