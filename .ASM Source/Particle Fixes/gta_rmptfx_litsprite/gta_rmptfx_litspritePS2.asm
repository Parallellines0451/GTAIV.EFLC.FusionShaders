// Fixed soft particles (they were using clip space depth instead of view space depth) + fixed explosion alpha
...
//
    ...
    cmp r0, -r2.x, r0, r1
	// ------------------------------------------------------------ Explosion Alpha Fix -------------------------------------------------------------
	// Workaround to fix the alpha of explosions as .wpfl files aren't editable by OpenIV
	if_eq v0.w, c1.y
		add r0.w, r0.w, -c2.x
