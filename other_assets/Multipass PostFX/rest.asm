// Removed edge blur + added console-like gamma + fixed DOF resolution scaling + fixed TLAD noise tiling + added dithering filter mask + fixed motion blur at high fps + added DOF and motion blur toggles + added noise and bloom toggles + color banding fix thanks to RaphaelK12
...
//
    ...
    texld r3, v0, s2
	mov r31, c1.x
	if_ne r31.x, c222.w // motion blur
		texld r0, v0, s1
		// ----------------------------------------------------------------- Log2Linear -----------------------------------------------------------------
		if_ne r0.x, c127.y
			rcp r20.x, c128.x
