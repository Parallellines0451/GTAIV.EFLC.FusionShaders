// Summary: simplified transparency code + fixed pop-in/added stippled transparency + custom stencil + vertex AO toggle + stipple mask + alpha toggle + adjust mipmap bias
...
//
    ...
    ps_3_0
    def c151, 0.9999, 0.012156862745098, 0.0274509803921569, 0 // Stipple Mask constants
    ...
    def c1, 0, -1, -0, 0.5
	def c2, 0.0235294117647059, 0, 0, 0
    dcl_texcoord v0.xy
