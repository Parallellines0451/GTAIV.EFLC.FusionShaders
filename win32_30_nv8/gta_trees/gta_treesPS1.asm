// Summary: Restored stippled transparency from 1.0.4.0 + custom stipple constants + increased alpha + new stencil + enabled vertex AO + dithering mask + alpha cutout toggle
