// Summary: simplified transparency code + fixed pop-in/added stippled transparency + fixed stencil value + stipple mask + alpha threshold + adjust mipmap bias + added alpha multiplier
