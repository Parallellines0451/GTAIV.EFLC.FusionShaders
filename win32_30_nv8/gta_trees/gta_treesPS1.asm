// Summary: simplified transparency code + fixed pop-in/added stippled transparency + fixed stencil value + vertex AO toggle + stipple mask + alpha threshold + adjust mipmap bias + added alpha multiplier
