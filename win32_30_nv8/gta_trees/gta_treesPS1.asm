// Summary: simplified transparency code + fixed pop-in/added stippled transparency + increased alpha + custom stencil + vertex AO toggle + stipple mask + alpha toggle
