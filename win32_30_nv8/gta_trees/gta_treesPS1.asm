// Restored stippled transparency from 1.0.4.0 + 256 state stipple + increased alpha + console tree lighting + enabled vertex AO + dithering mask + alpha cutout toggle
