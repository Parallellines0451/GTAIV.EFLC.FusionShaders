// Summary: Improved rain visibility and fixed FPS scaling + added streak length toggle
...
//
    ...
    if_ge -r1_abs.w, r1_abs.w
      ...
      lrp r7.x, r6.x, c3.z, c3.w
      mul r1.xyz, r1, r7.x // c73.x at 30 FPS == 0.015
