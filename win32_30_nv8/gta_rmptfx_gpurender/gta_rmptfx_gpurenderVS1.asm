// Summary: Improved rain visibility and fixed FPS scaling
...
//
	...
	def c3, 3, 0.33, 0.0333333, 0.015 // x = ambient multiplier, y = directional multiplier, z = frametime target
    dcl_position v0
    dcl_texcoord v1
    dcl_2d s0
    dcl_2d s1
    ...
    if_ge -r1_abs.w, r1_abs.w
      ...
      nrm r5.xyz, r4
	  rcp r20.x, c233.z
	  mul r20.x, r20.x, c3.z
	  mul r20.x, r20.x, c73.x
      mul r1.xyz, r1, r20.x
