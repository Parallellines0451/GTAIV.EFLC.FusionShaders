// Summary: 256 state stipple & changed stipple channel + improved window crossfade thanks to RaphaelK12 + on/off switch
...
//
    ...
    ps_3_0
    def c219, 1.8395173895e+25, 3.9938258725e+24, 4.5435787456e+30, 1.2093205747e-42 // 863
    ...
    mul r1.x, r1.x, c45.w
    mul r1.xyz, r0, r1.x
	mul r0.w, r0.w, c223.w // on/off switch
    // mul r1.w, r0.w, c39.x
	mov r1.w, r0.w
    mul oC0, r1, c51
	// ----------------------------------------------------------------- Linear2Log -----------------------------------------------------------------
