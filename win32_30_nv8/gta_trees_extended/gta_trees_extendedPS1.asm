// Summary: simplified transparency code + fixed pop-in/added stippled transparency + stipple mask + fixed stencil value + alpha threshold + adjust mipmap bias + added alpha multiplier
