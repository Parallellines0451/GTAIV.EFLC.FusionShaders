...
//
	...
	add r3.w, r3.w, -r22.y				// improve depth bias for 2nd, 3rd and 4th cascade
	// ----------------------------------------------------------------------------------------------------------------------------------------------
	// -------------------------------------------------------------- Filter Selection --------------------------------------------------------------
	mov r20.z, c223.y
	...
	if_gt r20.z, c117.w // "PCSS"
		...
		rep i2
			...
			rep i2
				mad r25.xy, c119.zw, r23.xy, r3.yz
				texldl r26, r25.xy, s15
	
				add r25.x, r26.x, -r3.w
	...
	rep i1
		...
		mad r24.xy, r21.zw, r20.xy, r3.yz	// offset * texel size + UV
		texld r24, r24, s15					// 2nd sample
		mov r25.y, r24.x					// copy to r25
		mad r24.xy, r21.xy, r20.xy, r3.yz	// offset * texel size + UV
	...
	// ----------------------------------------------------------------------------------------------------------------------------------------------
    add r1.w, r3.y, r1.w // mad r1.w, r3.y, c3.w, r1.w 1.0.6.0 filter average
    add r0.w, r0.w, -c53.w
