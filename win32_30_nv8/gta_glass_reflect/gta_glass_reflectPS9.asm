...
//
    ...
    def c2, 1.33333337, 9.99999975e-005, 1.5, 1
	...
	if_gt r20.z, c132.w // "PCSS"
		...
		rep i2
			...
			rep i2
				mad r25.xy, c53.xy, r23.xy, r1.xy
	...
	rep i1
		...
		mad r24.xy, r23.xy, r20.xy, r1.xy	// offset * texel size + UV
		texld r24, r24, s15					// 1st sample
		mov r25.x, r24.x					// copy to r25
		mad r24.xy, r21.zw, r20.xy, r1.xy	// offset * texel size + UV
		texld r24, r24, s15					// 2nd sample
		mov r25.y, r24.x					// copy to r25
		mad r24.xy, r21.xy, r20.xy, r1.xy	// offset * texel size + UV
		texld r24, r24, s15					// 3rd sample
		mov r25.z, r24.x					// copy to r25
		mad r24.xy, r23.zw, r20.xy, r1.xy	// offset * texel size + UV
