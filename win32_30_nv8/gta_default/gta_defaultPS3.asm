// Summary: simplified transparency code + fixed pop-in/added stippled transparency + stipple mask + alpha toggle + reduced specularity + custom fade curve
...
//
    ...
    mov r20.x, c39.x
    mad_sat r20.x, r20.x, c153.y, -c153.z
    mul r1.x, r0.w, r20.x
    mov r2.xyz, c0
