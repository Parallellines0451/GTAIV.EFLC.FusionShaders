// Summary: Restored stippled transparency from 1.0.4.0 + 256 state stipple & changed stipple channel + increased alpha + dithering mask + alpha cutout toggle + reduced specularity
