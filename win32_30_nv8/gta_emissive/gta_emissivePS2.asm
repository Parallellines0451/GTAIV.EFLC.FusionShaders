// Summary: simplified transparency code + improved window crossfade thanks to RaphaelK12 + fixed windows not covered by fog near the far plane if depth write is disabled
