// Added FXAA, fixed blurry screen, improved Definition setting behavior (doesn't affect stipple smoothing and DOF, only motion blur), console-like gamma, fixed DOF resolution scaling, console-like TLAD noise tiling
