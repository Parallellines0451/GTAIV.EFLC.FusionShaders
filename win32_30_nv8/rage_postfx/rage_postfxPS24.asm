// Summary: Added FXAA thanks to RaphaelK12, fixed blurry screen, improved Definition, console-like gamma, fixed DOF resolution scaling, fixed TLAD noise tiling + dithering mask + HQ motion blur + fixed motion blur FPS scaling
