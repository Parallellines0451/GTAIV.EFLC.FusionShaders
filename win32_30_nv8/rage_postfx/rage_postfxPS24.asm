// Summary: Fixed blurry screen, improved Definition, console-like gamma, fixed DOF resolution scaling, fixed TLAD noise tiling thanks to robi29 + dithering mask + fixed motion blur FPS scaling
...
//
	...
	def c133, 0.027843137254902, 0.0007843137254902, 0, 0 // 7.1, 0.2
	defi i1, 3, 0, 0, 0
	// ----------------------------------------------------------------------------------------------------------------------------------------------
    defi i0, 7, 0, 0, 0
    dcl_texcoord v0.xy
    ...
    min r0.x, c79.z, r1.w
	cmp r0.x, -c222.y, r30.x, r0.x	// DOF toggle
    dp3 r0.z, r7, c1.yzww
    dp3 r8.x, r3, c1.yzww
    dp3 r8.y, r4, c1.yzww
    dp3 r8.z, r5, c1.yzww
    ...
    mul r0.x, r0.x, r0.x
	cmp r0.z, -r29_abs.x, -c2.y, r0.z // Definition toggle
    ...
    frc r1.xy, r1
	// -------------------------------------------------------------- Noise Tiling Fix --------------------------------------------------------------
    mul r1.xy, r1.xy, c221.x // fix water quality dependency: Low, Medium, High, Very High = 2, 1, 0.5, 0.25
