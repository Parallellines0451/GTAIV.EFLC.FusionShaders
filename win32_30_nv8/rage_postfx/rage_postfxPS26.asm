// Summary: fixed blurry screen + added console-like gamma + fixed DOF resolution scaling + fixed TLAD noise tiling + added stipple filter mask + fixed motion blur at high fps + added DOF and motion blur toggles + color banding fix thanks to RaphaelK12
