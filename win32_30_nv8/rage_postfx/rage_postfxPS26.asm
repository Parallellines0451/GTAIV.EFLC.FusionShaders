// Added FXAA thanks to RaphaelK12, fixed blurry screen, improved Definition, console-like gamma, fixed DOF resolution scaling, console-like TLAD noise tiling + dithering mask + HQ motion blur
