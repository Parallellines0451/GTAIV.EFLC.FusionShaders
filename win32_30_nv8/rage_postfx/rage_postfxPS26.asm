// Summary: Added FXAA thanks to RaphaelK12, fixed blurry screen, improved Definition, console-like gamma, fixed DOF resolution scaling, fixed TLAD noise being affected by water quality + dithering mask + HQ motion blur + fixed motion blur FPS scaling
// Custom registers: c222, c221
...
//
	...
	// -------------------------------------------------------------- Noise Tiling Fix --------------------------------------------------------------
    mov r21.x, c221.x
    add r21.xyz, r21.x, -c12.yzw
    cmp r22.x, r21.x, c13.y, c13.x
    cmp r22.x, r21.y, c13.z, r22.xy
    cmp r22.x, r21.z, c13.w, r22.xy
    mul r1, r1, r22.x
	// ----------------------------------------------------------------------------------------------------------------------------------------------
    texld r1, r1, s3
    add r0.w, r1.z, c4.x
