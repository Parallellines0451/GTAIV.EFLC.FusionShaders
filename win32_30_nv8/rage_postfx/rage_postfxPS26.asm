// Summary: fixed blurry screen + added console-like gamma + fixed TLAD noise aspect ratio thanks to robi29 + fixed motion blur at high fps + color banding fix thanks to RaphaelK12 + moved DOF and stipple filter to dedicated passes + added tone mapping + bloom threshold toggle + fixed motion blur mask
