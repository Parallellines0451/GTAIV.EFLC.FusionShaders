// Summary: changes derived from PS26 + fixed phone camera aspect ratio
...
//
    ...
    def c7, 1.185185185185185, -0.7407407407407407, 0.625, 0
    ...
    dcl_2d s6
    dcl_2d s7
    dcl_2d s10 // StippleTexture set to linear clamp in gta_im
    
    // https://www.desmos.com/calculator/w5c2lj0chl
    mov r20.xy, v0
    mad r20.x, r20.x, c7.x, c7.y
    mul r20.z, c44.y, c44.z
    mad r20.x, r20.x, r20.z, c7.z
    ...
    mov r3, c4
    mad r4, c76.xyxy, r3.xyzx, r20.xyxy
    mad r6, c76.xyxy, r3.wzyw, r20.xyxy
    texld r7.xyz, r20, s2
    ...
    if_ne -c217_abs.z, c217_abs.z
      // Assume that input is gamma 2.2
      log r0.x, r0_abs.x
      log r0.y, r0_abs.y
      log r0.z, r0_abs.z
      mul r0.xyz, r0, c13.y
      ...
      exp r1.y, r1.y
      exp r1.z, r1.z
      mad r2.xyz, r1, c20.z, c20.w
      mad r1.xyz, r1, c21.x, c21.y
      rcp r1.x, r1.x
      rcp r1.y, r1.y
      rcp r1.z, r1.z
      mul r1.xyz, r1, r2
      ...
      mov r1.zw, c1.x
      texldl r2.xyz, r1, s10
      add r1.x, r1.x, c10.w
      texldl r1.xyz, r1, s10
