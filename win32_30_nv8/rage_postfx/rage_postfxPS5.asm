// Summary: fixed autoexposure flickering
...
//
    ...
    def c0, 0, -0.9999999, 1, 0 // c0.y = -1 causes flickering in some vanilla weathers that have 0.10 LumDelay due to floating point error
    dcl_2d s0
    dcl_2d s1
    add r0.x, c72.x, c72.x // AdaptTime = timecyc LumDelay * 10
    rsq r0.x, r0.x
    mul r0.x, r0.x, c66.x
    min r1.x, r0.x, c0.z
    texld r0, c0.x, s1
