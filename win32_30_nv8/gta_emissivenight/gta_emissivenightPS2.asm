// Summary: 256 state stipple & changed stipple channel + improved window crossfade thanks to RaphaelK12 + light on/off switch
...
//
	...
	mov r20.x, c1.w
	if_ne c207.x, r20.x
		mul r0.w, r0.w, c223.w // light on/off switch
	endif
    // mul r1.w, r0.w, c39.x
	mov r1.w, r0.w
    mul oC0, r1, c51
