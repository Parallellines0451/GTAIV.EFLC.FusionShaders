// Summary: simplified transparency code + improved window crossfade thanks to RaphaelK12 + light on/off switch + fixed windows not covered by fog near the far plane if depth write is disabled
...
//
    ...
    def c153, 0.5, 2, 1, 0
    def c127, 0.9999999, 1, 0.999, 0	// LogDepth constants
