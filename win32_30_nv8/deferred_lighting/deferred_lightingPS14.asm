...
//
    ...
    def c112, 3, 4.27199984, 2, 0.3333333
	...
	mad_sat r24.xy, r23.xy, r20.x, r4.xy	// offset * texel size + UV
	mad r24.xy, r24, c77.w, c77
	texld r24, r24, s14						// 5th sample
	dp2add r25.x, r24, r4.zw, c110.w		// copy to r25
	mad_sat r24.xy, r21.zw, r20.x, r4.xy	// offset * texel size + UV
	mad r24.xy, r24, c77.w, c77
	texld r24, r24, s14						// 6th sample
	dp2add r25.y, r24, r4.zw, c110.w		// copy to r25
	mad_sat r24.xy, r21.xy, r20.x, r4.xy	// offset * texel size + UV
	mad r24.xy, r24, c77.w, c77
	texld r24, r24, s14						// 7th sample
	dp2add r25.z, r24, r4.zw, c110.w		// copy to r25
	mad_sat r24.xy, r23.zw, r20.x, r4.xy	// offset * texel size + UV
	mad r24.xy, r24, c77.w, c77
	texld r24, r24, s14						// 8th sample
	dp2add r25.w, r24, r4.zw, c110.w		// copy to r25
	mad r25, r1.w, c66.w, r25				// depth bias
	cmp r25, r25, c110.y, c110.w
	...
	mad_sat r24.xy, r23.xy, r20.x, r4.xy	// offset * texel size + UV
	mad r24.xy, r24, c77.w, c77
	texld r24, r24, s14						// 9th sample
	dp2add r25.x, r24, r4.zw, c110.w		// copy to r25
	mad_sat r24.xy, r21.zw, r20.x, r4.xy	// offset * texel size + UV
	mad r24.xy, r24, c77.w, c77
	texld r24, r24, s14						// 10th sample
	dp2add r25.y, r24, r4.zw, c110.w		// copy to r25
	mad_sat r24.xy, r21.xy, r20.x, r4.xy	// offset * texel size + UV
	mad r24.xy, r24, c77.w, c77
	texld r24, r24, s14						// 11th sample
	dp2add r25.z, r24, r4.zw, c110.w		// copy to r25
	mad_sat r24.xy, r23.zw, r20.x, r4.xy	// offset * texel size + UV
	mad r24.xy, r24, c77.w, c77
	texld r24, r24, s14						// 12th sample
	dp2add r25.w, r24, r4.zw, c110.w		// copy to r25
	mad r25, r1.w, c66.w, r25				// depth bias
	cmp r25, r25, c110.y, c110.w
