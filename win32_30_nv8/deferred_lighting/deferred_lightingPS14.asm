// Summary: fixed mismatched AO with other lights thanks to AssaultKifle47 + improved shadow filter + adjusted normal encoding
...
//
    ...
    def c8, 17.0666666, 1.3333333, 0, 0.125
    ...
    mul r3.xyz, r2.w, c1
    frc r3.xyz, r3
    mad r3.xy, r3.yzzw, -c8.w, r3
    mad r2.xyz, r2, c0.w, r3
    add r2.xyz, r2, c1.w
    nrm r3.xyz, r2
    texld r2, r0.zwzw, s4
