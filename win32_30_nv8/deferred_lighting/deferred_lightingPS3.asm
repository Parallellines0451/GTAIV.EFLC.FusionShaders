// Summary: console tree lighting thanks to AssaultKifle47 + improved PC tree lighting + added unclamped directional toggle + adjusted normal encoding
