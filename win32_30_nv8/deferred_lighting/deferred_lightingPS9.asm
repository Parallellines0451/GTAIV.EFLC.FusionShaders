// Summary: added stipple mask stencil values
...
//
    ...
    def c4, 9.99999975e-006, 1.11111116, 0.0007843137254902, 0
	def c5, 0.0043137254901961, 0.0356862745098039, 0.5062745098039216, 0.5376470588235294 // 1.1, 9.1, 129.1, 137.1
	def c6, 0.016078431372549, 0.0474509803921569, 0.5180392156862745, 0.5494117647058824 // 4.1, 12.1, 132.1, 140.1
    dcl_texcoord v0
    dcl vPos.xy
    dcl_texcoord9 v9
    dcl_2d s0
	...
	add r20, r0.x, -c5
	add_sat r20, -r20_abs, c4.z
	add r21, r0.x, -c6
	add_sat r21, -r21_abs, c4.z
	add r20, r20, r21
	dp4 r20.x, r20, -c3.z
	cmp r0.x, -r20_abs.x, -c3.y, -c3.z
