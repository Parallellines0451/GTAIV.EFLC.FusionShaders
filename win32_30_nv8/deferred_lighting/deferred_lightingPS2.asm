// Improved shadow filtering, depth bias, cascade blur disparity and distance fade + console-like ambient reflection intensity
...
//
    ...
    mov r7.z, c0.x
    texldl r7, r7, s6
	mul r7, r7, c20.x	// reflection intensity
    mul r3.xyz, r0.x, r7
