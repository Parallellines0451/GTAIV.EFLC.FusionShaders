// Summary: Improved shadow filter + restored normal offset bias + improved shadow fadeout + restored xbox reflection intensity + console tree lighting thanks to AssaultKifle47 + fixed trees' orange glow
...
//
    ...
    if_eq r21.y, c4.w
      ...
      cmp r2.xyz, -r21_abs.x, r2, r22 // Tree orange glow tweak
