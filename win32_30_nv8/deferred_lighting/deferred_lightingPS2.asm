// Summary: improved cascaded shadows + console tree lighting thanks to AssaultKifle47 + improved PC tree lighting + added unclamped directional toggle + adjusted normal encoding
...
//
    ...
    def c1, 0.998046875, 7.984375, 63.875, 0.25
