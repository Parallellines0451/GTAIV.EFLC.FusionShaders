...
//
    ...
    def c6, 10, 0, 0, 0
	def c7, 3, 2, 1, 0.01171875	// Console tree lighting constants
	...
	texld r21, v0, s5
	add r21.x, r21.x, -c7.w
	mov r21.y, c223.x
	add r21.y, r21.y, -c7.y
	cmp r21.y, r21.y, -r21_abs.x, -c3.z	// Console tree lighting toggle
	if_lt r21.y, c0.x
		texld r0, v0, s1
		mul r1.xyz, r0.w, c1
		frc r1.xyz, r1
	...
	// ----------------------------------------------------------------------------------------------------------------------------------------------
		...
		mov r4.xyz, c38
		if_eq -r21_abs.x, c0.x // Tree orange glow fix
			add r4.xyz, r4.xyz, c37
			mul r4.xyz, r4.xyz, c3.y
		endif
