// Summary: Console-like ambient reflection intensity + console tree lighting thanks to AssaultKifle47 + stipple mask + fixed trees' orange glow
...
//
	...
	// ----------------------------------------------------------------------------------------------------------------------------------------------
		...
		add r0.z, r20.x, r20.y // change wetness mask to include stencil 3 alongside 0 (since 3 is now used for the stipple mask)
		cmp r0.y, -r0.z, c0.x, r0.y
