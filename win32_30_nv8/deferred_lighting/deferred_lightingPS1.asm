// Summary: Improved shadow filter + added PCSS thanks to robi29 + console-like ambient reflection intensity + console tree lighting thanks to AssaultKifle47 + fixed trees' orange glow
