// Summary: Improved shadow filter + improved shadow fadeout + console-like ambient reflection intensity + console tree lighting thanks to AssaultKifle47 + fixed trees' orange glow
