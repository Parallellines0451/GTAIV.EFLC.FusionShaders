// Summary: added volumetric fog to water reflection + unclamp sun brightness
...
//
    ...
    mul r20.w, c44.x, c44.w
    add r20.w, r20.w, -c142.y
    cmp r20.w, -r20_abs.w, c142.z, c142.w
    mul r20.w, r20.w, c210.y
    if_eq -r20_abs.w, r20_abs.w
      mov r20.x, c141.z
    else
      mov r20.x, -v6.x
      mov r20.y, v6.y
      mul r20.xy, r20.xy, c211.y
    ...
    mul r0.w, r0.w, r20.x // apply fog
    lrp_pp r1.xyz, r0.w, r5, r0
    mul_pp r0.xyz, r1, c88.x
    min_pp r1.xyz, r0, c90
    
    cmp r1.xyz, -c210_abs.y, r1, r0 // unclamp sun brightness if vol fog is enabled
    
    mul r1.w, r20.w, c41.w
    lrp r0.xyz, r1.w, c43, r1 // mix sky reflection with near fog color
