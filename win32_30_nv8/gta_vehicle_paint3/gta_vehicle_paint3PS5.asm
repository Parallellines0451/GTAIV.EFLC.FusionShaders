// Fixed blocky car reflections thanks to AssaultKifle47 & disabled PC parameters that cause the dirt level in vehicle.ide to affect reflection intensity
