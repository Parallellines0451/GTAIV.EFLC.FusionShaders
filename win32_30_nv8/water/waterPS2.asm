// Summary: improved shadow filter + restored normal offset bias + improved shadow fadeout + fixed water shadows + fixed outlines + improved water transparency + improved foam texture
