// Summary: improved cascaded shadows + fixed water shadows + fixed shore outlines + improved water transparency + improved foam texture + fixed offset reflections + remapped shadowmap depth
