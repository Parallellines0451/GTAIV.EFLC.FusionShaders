// Summary: Restored stippled transparency from 1.0.4.0 + 256 state stipple & changed stipple channel + increased alpha + new stencil + enabled vertex AO + dithering mask + alpha cutout
...
//
    ...
    ps_3_0
    def c219, 1.8395173895e+25, 3.9938258725e+24, 4.5435787456e+30, 1.1995114855e-42 // 856
    ...
    def c1, -1, -0, 0.5, 0
	def c2, 0.01953125, 2, 2, 0	// x = stencil
    dcl_texcoord v0.xy
