// Summary: Disabled PC parameters that cause the dirt level in vehicle.ide to affect reflection intensity + console-like ambient reflection intensity + improved shadow filter + improved shadow fadeout
...
//
	...
	dp3 r6.w, r26, c112.z
	// ----------------------------------------------------------------------------------------------------------------------------------------------
    add r4.w, r6.w, r4.w // mad r4.w, r6.w, c5.w, r4.w 1.0.6.0 filter average
    add r1.w, r1.w, -c53.w
